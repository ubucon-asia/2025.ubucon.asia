...
<a href="/ubucon-asia-2025-sponsorship-prospectus.pdf"><button class="p-button">See Sponsorship Prospectus</button></a>
...
| Sponsor booth | L | M | S<sup>*4</sup> | S<sup>*4</sup> (500 USD or 30,000 NPR<sup>*0</sup> Add-on FCFS) | No |
